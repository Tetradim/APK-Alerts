...
export function EnginesScreen() {
  ...
  const importPackage = () => {
    ...
    setPairingImportStatus(`Imported ${result.evidence.pairingPackageImportedAt}`);
  };
    ...
    <ScreenFrame title="Engines" eyebrow="APK-Alerts">
      ...
      <View style={styles.panel}>
        ...
        <Text style={styles.detail}>
          Paste the JSON generated by the Windows installer to fill the remote URL and API key.
        </Text>
        <TextInput
          value={pairingPackageText}
          onChangeText={setPairingPackageText}
          placeholder={'{ "version": 1, "remoteApiUrl": "http://100.x.x.x:8003/api" }'}
          placeholderTextColor="#94a3b8"
