    ...
    <ScreenFrame title="Engines" eyebrow="Sentinel Nexus">
      ...
      <View style={styles.panel}>
        ...
        <Text style={styles.detail}>
          Paste the JSON or sentinelnexus://pair link generated by the Windows installer.
        </Text>
        <TextInput
          value={pairingPackageText}
          onChangeText={setPairingPackageText}
          placeholder={'{ "version": 1, "remoteApiUrl": "http://100.x.x.x:8003/api" } or sentinelnexus://pair?...'}
          placeholderTextColor="#94a3b8"
