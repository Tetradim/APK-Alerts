...
import com.tetradim.apkalerts.R
...
class PhoneEngineForegroundService : Service() {
  ...
  private fun createNotificationChannel() {
    ...
    val channel = NotificationChannel(
      CHANNEL_ID,
      "APK Alerts phone engine",
      NotificationManager.IMPORTANCE_LOW,
    ).apply {
      description = "Keeps the Mobile Consolidation engine alive for alert ingestion and broker reconciliation."
      setShowBadge(false)
    }
  ...
  private fun buildNotification(): Notification {
    ...
    return builder
      .setContentTitle("APK Alerts phone engine")
