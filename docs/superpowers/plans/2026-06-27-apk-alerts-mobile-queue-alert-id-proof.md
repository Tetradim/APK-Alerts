# APK Alerts Mobile Queue Alert ID Proof Implementation Plan
...
```powershell
git add docs/superpowers/plans/2026-06-27-apk-alerts-mobile-queue-alert-id-proof.md apps/mobile/src/state/alertEvidenceState.ts apps/mobile/src/state/alertEvidenceState.test.ts
