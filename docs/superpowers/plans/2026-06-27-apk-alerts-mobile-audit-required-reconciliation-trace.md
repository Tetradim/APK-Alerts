# APK Alerts Mobile Audit Required Reconciliation Trace Implementation Plan
...
```powershell
git add docs/superpowers/plans/2026-06-27-apk-alerts-mobile-audit-required-reconciliation-trace.md apps/mobile/src/state/alertEvidenceState.ts apps/mobile/src/state/alertEvidenceState.test.ts
