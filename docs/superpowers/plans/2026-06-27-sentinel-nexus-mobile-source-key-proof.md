# Sentinel Nexus Mobile Source Key Proof Implementation Plan
...
```powershell
git add docs/superpowers/plans/2026-06-27-sentinel-nexus-mobile-source-key-proof.md apps/mobile/src/state/alertEvidenceState.ts apps/mobile/src/state/alertEvidenceState.test.ts
