# APK-Alerts Mobile Live Arm Checklist Implementation Plan
...
```bash
git add docs/superpowers/plans/2026-06-27-apk-alerts-mobile-live-arm-checklist.md apps/mobile/src/state/liveReadinessState.ts apps/mobile/src/state/liveReadinessState.test.ts apps/mobile/src/screens/MoreScreen.tsx
