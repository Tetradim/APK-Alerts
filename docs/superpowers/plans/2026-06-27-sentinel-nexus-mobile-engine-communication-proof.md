# Sentinel Nexus Mobile Engine Communication Proof Implementation Plan
...
Run: `npm --workspace @sentinel-nexus/mobile exec -- tsx --test src/screens/CockpitScreen.test.ts`
...
```bash
git add docs/superpowers/plans/2026-06-27-sentinel-nexus-mobile-engine-communication-proof.md apps/mobile/src/state/operatorState.ts apps/mobile/src/screens/CockpitScreen.test.ts apps/mobile/src/screens/CockpitScreen.tsx
