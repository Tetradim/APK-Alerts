# Sentinel Nexus Mobile Source Reconciliation Trace Implementation Plan
...
```bash
git add docs/superpowers/plans/2026-06-27-sentinel-nexus-mobile-source-reconciliation-trace.md apps/mobile/src/state/alertEvidenceState.ts apps/mobile/src/state/alertEvidenceState.test.ts apps/mobile/src/screens/AlertsScreen.tsx
