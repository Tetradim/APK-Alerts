# APK Alerts Mobile Physical Capture Proof Implementation Plan
...
```powershell
git add docs/superpowers/plans/2026-06-27-apk-alerts-mobile-physical-capture-proof.md apps/mobile/src/state/alertEvidenceState.ts apps/mobile/src/state/alertEvidenceState.test.ts
