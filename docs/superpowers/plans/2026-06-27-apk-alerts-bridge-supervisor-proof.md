# APK Alerts Bridge Supervisor Proof Implementation Plan
...
```powershell
npm --workspace @apk-alerts/contracts exec -- tsx --test src/bridgeEvidence.test.ts
...
```powershell
git add docs/superpowers/plans/2026-06-27-apk-alerts-bridge-supervisor-proof.md packages/contracts/src/bridgeEvidence.ts packages/contracts/src/bridgeEvidence.test.ts apps/mobile/src/state/alertEvidenceState.test.ts
