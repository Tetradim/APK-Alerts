# APK Alerts Mobile Parser Payload Proof Implementation Plan
...
```powershell
git add docs/superpowers/plans/2026-06-27-apk-alerts-mobile-parser-payload-proof.md apps/mobile/src/state/alertEvidenceState.ts apps/mobile/src/state/alertEvidenceState.test.ts
