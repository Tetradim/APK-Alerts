# APK-Alerts Settings And Failover Controls Implementation Plan
...
```powershell
npm --workspace @apk-alerts/contracts test
```
...
```powershell
npm --workspace @apk-alerts/contracts test
npm --workspace @apk-alerts/contracts run typecheck
```
...
```powershell
npm --workspace @apk-alerts/mobile test
```
