...
```bash
git add docs/superpowers/plans/2026-06-27-apk-alerts-mobile-oco-exit-evidence.md apps/mobile/src/state/liveReadinessState.ts apps/mobile/src/state/liveReadinessState.test.ts apps/mobile/src/screens/PositionsScreen.tsx
