...
```bash
git add docs/superpowers/plans/2026-06-27-apk-alerts-mobile-replay-acceptance-evidence.md apps/mobile/src/state/liveReadinessState.ts apps/mobile/src/state/liveReadinessState.test.ts apps/mobile/src/screens/MoreScreen.tsx
