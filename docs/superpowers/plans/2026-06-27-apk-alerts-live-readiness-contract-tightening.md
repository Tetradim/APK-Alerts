# APK Alerts Live Readiness Contract Tightening Implementation Plan
...
Run: `npm --workspace @apk-alerts/contracts exec -- tsx --test src/liveReadiness.test.ts`
...
Run: `npm --workspace @apk-alerts/mobile exec -- tsx --test src/state/liveReadinessState.test.ts`
...
```powershell
npm --workspace @apk-alerts/contracts exec -- tsx --test src/liveReadiness.test.ts
npm --workspace @apk-alerts/mobile exec -- tsx --test src/state/liveReadinessState.test.ts
```
...
```powershell
git add docs/superpowers/plans/2026-06-27-apk-alerts-live-readiness-contract-tightening.md packages/contracts/src/liveReadiness.ts packages/contracts/src/liveReadiness.test.ts apps/mobile/src/state/liveReadinessState.ts apps/mobile/src/state/liveReadinessState.test.ts
