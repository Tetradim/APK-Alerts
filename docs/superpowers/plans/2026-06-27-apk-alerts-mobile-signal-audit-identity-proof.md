# APK Alerts Mobile Signal Audit Identity Proof Implementation Plan
...
```powershell
git add docs/superpowers/plans/2026-06-27-apk-alerts-mobile-signal-audit-identity-proof.md apps/mobile/src/state/alertEvidenceState.ts apps/mobile/src/state/alertEvidenceState.test.ts
